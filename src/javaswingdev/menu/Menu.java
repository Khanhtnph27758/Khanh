...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("SẢN PHẨM");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ADB, "Mặt hàng"));
        addTitle("GIAO DỊCH");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SHOPPING_BASKET, "Nhập hàng"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SHOPPING_CART, "Bán hàng"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.REMOVE_SHOPPING_CART, "Trả hàng"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ACCOUNT_BALANCE, "Hóa đơn nhập hàng"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST,  "Hóa đơn bán hàng"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ADJUST, "Hóa đơn trả hàng"));
        addTitle("THỐNG KÊ");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PIE_CHART_OUTLINED, "Thống Kê"));
        addTitle("QUẢN LÍ");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ACCESSIBILITY, "Quản Lí","Nhân Viên", "Khách Hàng","Cá Nhân"));
        
        addTitle("KHUYẾN MÃI");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MAIL_OUTLINE, "Khuyến Mãi"));
        addTitle("ĐĂNG XUẤT");
