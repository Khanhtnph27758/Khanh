...
import javaswingdev.form.HoaDonNhapHangForm;
import javaswingdev.form.QLSPForm;
import javaswingdev.form.NhapHangForm;
import javaswingdev.form.HoaDonTraHangForm;
            ...
            public void menuSelected(int index, int indexSubMenu) {
                if (index == 0 && indexSubMenu == 0) {
                    showForm(new Form_Dashboard());
                     ...
                     showForm(new QLSPForm());
                } else if(index == 2 && indexSubMenu == 0){
                    showForm(new NhapHangForm());
                } else if(index == 5 && indexSubMenu == 0){
                    showForm(new HoaDonNhapHangForm());
                } else if(index == 6 && indexSubMenu == 0){
                     //showForm(new Views.HoaDon());
                } else if(index == 7 && indexSubMenu == 0){
                    showForm(new HoaDonTraHangForm());
                }
